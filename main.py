...
prefixL = ['ה', 'ו', 'מ', 'ב','כ', 'ש', 'ל']
prephrase = ['ת', 'ה', 'ו', 'מ', 'ב','כ', 'ש', 'ל']
plural = ['תו', 'םי', 'םיי']
modern = ['קינ', 'רטמ', 'הקס', 'םינו', 'דיאו', 'ןמ', 'הינמ', 'סיזניק', 'פוקס', 'היפרג', 'היצ', 'ןקי', 'הקי', 'טסי', 'םזי', 'הז', 'יל', 'יא']
metathesis = ['ס', 'ש', 'צ']
...
class Word:
    def __init__(self, t, d):
        ...
        self.Verb = False
        self.Noun = False
        self.prefixD = {"ה":"the", "ו":"and", "ב":"in", "מ":"from", "ל":"to", "כ":"as", "ש":"which"}
...
class HebrewDictionary(App):
    ...
    def getWList(self, text, i, tk, k, n):
        ...
        if(len(look.getWords()) > 0):
            for wi in WList:  
                ...
                script = TAB2*n + TAB2 + val + (modern[:-3])*2 + prL + (pre) + (s6[:-(preN-1)])*(2) + preSP + (verbform)*2 + s1 + (tense)*(2) + s2*6 + person + s3 + gender + s4 + (constr[:-1])*2 + s5 + (suff) + (s7[:-1])*(2) + suffSP + pl*2 + prR + "- " + (w.getText()[:-1])*(2) + TAB + '-' + TAB
                spaces = len(script) - cn
                self.wText += '\t\t'*n +  '\t\t' + val + modern + prL + pre + s6 + preSP + w.getVerbform() + s1 + w.getTense() + s2 + w.getPerson() + s3 + w.getGender() + s4 + constr + s5 + suff + s7 + suffSP + pl + prR + "- " + w.getText() + '\t' + '-' + '\t' + self.fixDef(definition, spaces) + ';' + ' gmra. = ' + str(w.getGemontria()) + '\n'
        else:
    ...
    def imperative(self, look, word):
        if(word.getLen() < 3) or (not(word.getTenseVal() == -1))or (word.isNoun() == True):
            return Word("","")
    ...
    def plural(self, look, word):
        if(word.getLen() < 3) or (word.isVerb() == True) or (word.getPlural() == True) or (word.getDaul() == True) or (word.getConstruct() == True):
             return Word("", "")
    ...
    def suffixObj(self, look, word):
        if(word.getLen() < 2) or (word.isTense() == True) or (word.isNoun() == True) or (word.getSuffix() == True) or (word.getPlural() == True) or (word.getDaul() == True) or (word.getConstruct() == True):
            return Word("","")
        if word.getLen() > 2:
            if(word.last2() == 'םי'):
                return Word("","")
        if word.getLen() > 3:
            ...
            if(self.CurrentWord.last2() == word.last2()) and (word.last2() in suffixObj):
                ...
                elif(not 'ה' in suffW.getSufxList()) and (not ('ה' in word.getSufxList())) and (not ((word.getGender() == "f.")and(word.getPerson() == '3rd, sg.')and(word.getTense() == 'Perfect')and(not('ו' in word.getPrixList())))) and (not ((word.getGender() == "f.")and(word.getTense() == 'Imperfect')and(word.getPerson() == '3rd, sg.')and('ו' in word.getPrixList()))):
                    suffWh = Word("","")
        ...
        if(self.CurrentWord.last() == word.last()) and (word.last() in suffixObj):
            ...
            if (suffW.getLen() > 2) and (suffW.last() == 'י') and (not (word.last() == 'י')):
                ...
                look.find(suffW2, self.Dict)
                self.algorithm(look, suffW2)
                if(not 'ה' in suffW.getSufxList()) and (not ('ה' in word.getSufxList())) and (not ((word.getGender() == "f.")and(word.getPerson() == '3rd, sg.')and(word.getTense() == 'Perfect')and(not("ו" in word.getPrixList())))) and (not ((word.getGender() == "f.")and(word.getTense() == 'Imperfect')and(word.getPerson() == '3rd, sg.')and("ו" in word.getPrixList()))):
                    suffW2h = Word("","")
                    suffW2h.equalTo(suffW2)
                    suffW2h.setText('ה' + self.unFinal(suffW2.getText()))
                    look.find(suffW2h, self.Dict)
            ...
            if(not(word.last() == 'ה')) and  (not 'ה' in suffW.getSufxList()) and (not ('ה' in word.getSufxList())) and (not ((word.getGender() == "f.")and(word.getPerson() == '3rd, sg.')and(word.getTense() == 'Perfect')and(not("ו" in word.getPrixList())))) and (not ((word.getGender() == "f.")and(word.getTense() == 'Imperfect')and(word.getPerson() == '3rd, sg.')and("ו" in word.getPrixList()))):
                suffWh = Word("","")
                suffWh.equalTo(suffW)
    ...
    def suffix(self, look, word, p):
        if(word.getLen() < 3) or (word.getConstruct() == True)or (word.isVerb() == True) or (word.getSuffix() == True) or (word.getPlural() == True) or (word.getDaul() == True) or (not (word.getTenseVal() == -1)):
            return Word("","")
    ...
    def suffix1(self, look, word):
        if(word.getLen() < 2) or (word.isVerb() == True) or (word.getSuffix() == True) or (word.getPlural() == True) or (word.getDaul() == True) or (word.getConstruct() == True) or (word.last2() == 'םי') or (word.last3() == 'םיי'):
            return Word("","")
        ...
        if (self.CurrentWord.last() == cPhraseSuf.last()) and (cPhraseSuf.last() in suffix):
            ...
            if(not(cPhraseSuf.last() == 'ה')) and (not 'ה' in suffW.getSufxList()) and (not ('ה' in cPhraseSuf.getSufxList())) and (not ((cPhraseSuf.getGender() == "f.")and(cPhraseSuf.getPerson() == '3rd, sg.')and(cPhraseSuf.getTense() == 'Perfect')and(not("ו" in cPhraseSuf.getPrixList())))) and (not ((cPhraseSuf.getGender() == "f.")and(cPhraseSuf.getTense() == 'Imperfect')and(cPhraseSuf.getPerson() == '3rd, sg.')and("ו" in cPhraseSuf.getPrixList()))):
                suffWh = Word("","")
                suffWh.equalTo(suffW)
    ...
    def suffix2(self, look, word):
        if(len(word.getText()) < 3) or (word.isVerb() == True) or (word.getSuffix() == True) or (word.getPlural() == True) or (word.getDaul() == True) or (word.getConstruct() == True):
            return Word("","")
    ...
    def participle(self, look, word):
        ...
        if(word.last() == 'ת'):
            ...
            if(fimW.nextToFirst() == 'ו'):
                ...
                return pfimW        
            if(fimW.nextToLast() == 'ו') and (not ('ה' in word.getSufxList())) and (not ((word.getGender() == "f.")and(word.getPerson() == '3rd, sg.')and(word.getTense() == 'Perfect')and(not("ו" in word.getPrixList())))) and (not ((word.getGender() == "f.")and(word.getTense() == 'Imperfect')and(word.getPerson() == '3rd, sg.')and('ו' in word.getPrixList()))):
                pfimW = Word("","")
                pfimW.equalTo(fimW)
    ...
    def constr(self, look, word):
        ...
        if(word.getLen() > 2):
            if(not ('י' in word.getSufxList())) and (word.last() == 'י') and (not('ם' in word.getSufxList())):
                constW = Word("","")
                constW.equalTo(word)
        ...
        if(word.getLen() > 2) and (word.last() == 'ת') and (not ((word.getGender() == "f.")and(word.getPerson() == '3rd, sg.')and(word.getTense() == 'Perfect')and(not('ו' in word.getPrixList())))) and (not ((word.getGender() == "f.")and(word.getTense() == 'Imperfect')and(word.getPerson() == '3rd, sg.')and('ו' in word.getPrixList()))):
            constW = Word("","")
            constW.equalTo(word)
    ...
    def irreg(self, look, word):
        ...
        if ((word.getLen() == 1) or ((word.getLen() == 2)and(word.last() == 'ת'))) and ((word.getTense() == 'Imperfect') or (word.getTense() == 'Imperative') or (word.getTense() == 'Infinitive') or (word.getPrefix() == True)) and (not(('ו' in word.getPrixList())and(word.getTense() == 'Perfect')and(word.getPerson() == '1st, pl.'))) and (not((not ('ו' in word.getPrixList()))and(word.getTense() == 'Imperfect')and(word.getPerson() == '1st, pl.'))) and (not (word.getVerbform() == 'Niphal')):
            ...
            if(not ('ה' in word.getSufxList())) and (not (self.CurrentWord.first() == 'ה')) and (not ((word.getGender() == "f.")and(word.getPerson() == '3rd, sg.')and(word.getTense() == 'Perfect')and(not('ו' in word.getPrixList())))) and (not ((word.getGender() == "f.")and(word.getTense() == 'Imperfect')and(word.getPerson() == '3rd, sg.')and('ו' in word.getPrixList()))):
                irregWh = Word("","")
        ...
        if(word.getLen() == 2):
            if(not(word.getTense() == 'Particible')) and (not(word.getVerbform() == 'Pual')):
                irreg1 = Word("","")
                irreg1.equalTo(word)
        ...
        if (word.getLen() > 3) and (('ו' in word.getPrixList()) or (word.getTense() == "Perfect") or (word.getTense() == "Imperfect") or (word.getTense() == "Imperative") or (word.getTense() == "Infinitive")):
            if((not(((word.getConstruct() == True) and (((word.getPlural() == True)and(self.CurrentWord.getX(self.CurrentWord.getLen() - 2) == word.last())) or ((word.getDaul() == True)and(self.CurrentWord.getX(self.CurrentWord.getLen() - 3) == word.last())))) or ((word.getConstruct() == False) and (((word.getPlural() == True)and(self.CurrentWord.getX(self.CurrentWord.getLen() - 3) == word.last())) or ((word.getDaul() == True)and(self.CurrentWord.getX(self.CurrentWord.getLen() - 4) == word.last())))))) and (not((word.getConstruct() == True)and((word.getPlural() == False)and(word.getDaul() == False)) and (self.CurrentWord.last2()[-1:] == word.last()))) or ((word.getTense() == "Imperfect")and('ו' in word.getPrixList())) or ((word.getTense() == "Perfect")and(not 'ו' in word.getPrixList()))) and (word.getSuffix() == True) and (not ('ה' in word.getSufxList())):
                if(not ('ה' in word.getSufxList())):
                    ...
                    #irregW = Word("","")
                    #irregW.equalTo(word)
                    #irregW.setText('ה' + word.getText()[1:])
                    #look.find(irregW, self.Dict)
            elif (word.getTense() == "Imperative"):
                irregW = Word("","")
                irregW.equalTo(word)
                irregW.setText('ה' + self.unFinal(word.getText()))
                look.find(irregW, self.Dict)
        ...
        if (word.getPrefix() == True) or (word.getTense() == 'Infinitive') or (word.getTense() == 'Imperfect') or (self.CurrentWord.first() == 'ו'):
            if (not(word.getIrregVal() > 0)) and ((not ('ה' in word.getPrixList())) and (not (self.CurrentWord.first() == 'ה')) and (not (word.first() == 'ה'))) and ((word.getPrefix() == True) or (word.getTense() == 'Infinitive')):
                irregW = Word("","")
                irregW.equalTo(word)
            ...
            if(word.getLen() > 1):
                ...
                if(not ('ה' in word.getSufxList())) and (word.last() == 'י') and (not(self.CurrentWord.last() == 'י')):
                    irregW6 = Word("","")
