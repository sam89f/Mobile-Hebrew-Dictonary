...
class HebrewDictionary(App):
    ...
    def hifil(self, look, word):
        ...
        if(word.getLen() < 5) or ((word.isVerbf() == True) and (not(word.getVerbform() in rareVerbforms))) or (word.getPartiVal() == 1) or (word.getTenseVal() == 0) or (word.getConstruct() == True):
            return Word("","")
                ...
                if((word.fourthFromLast() == 'י')and(word.XfromLast(5) == 'י')) and (self.num_of_p_roots(word.getText()[5:-1]) < 3):
                    if((word.first() == 'י') or (word.first() == 'נ' ) or (word.first() == 'ת' ) or (word.first() == 'א')) and (not((word.first() == 'ת')and(word.last2() == 'הנ'))):
                        ...
                        if(word.first() == 'ת'):
                            tifilW = Word("","")
                            tifilW.equalTo(word)
                            tifilW.setText(word.last3() + word.getText()[5:-1])
                            tifilW.setRL2(tifilW.thirdFromLast() + tifilW.fourthFromLast())
                    ...
                    if(not((word.last() == 'ת')or(word.last2() == 'ונ')or(word.last2() == 'ית')or(word.last2() == 'םת')or(word.last2() == 'תן'))):
                        if(word.first() == 'ת'):
                            ...
                            if(word.first2() == 'ית') and (not((word.last() == 'ת')or(word.last2() == 'ונ')or(word.last2() == 'ית')or(word.last2() == 'םת')or(word.last2() == 'תן'))):
                                tifilW2 = Word("","")
                                tifilW2.equalTo(word)
                                tifilW2.setText(word.last3() + word.getText()[5:-2])
                                tifilW2.setRL2(tifilW2.thirdFromLast() + tifilW2.fourthFromLast())
                        ...
                        if(word.first() == 'ה'):
                            ...
                            if(word.first2() == 'יה') and (not((word.last() == 'ת')or(word.last2() == 'ונ')or(word.last2() == 'ית')or(word.last2() == 'םת')or(word.last2() == 'תן'))):
                                hifilW2 = Word("","")
                ...
                if(word.fourthFromLast() == 'י') and (self.num_of_p_roots(word.getText()[4:-1]) < 3):
                    if((word.first() == 'י') or (word.first() == 'נ' ) or (word.first() == 'ת' ) or (word.first() == 'א')) and (not((word.first() == 'ת')and(word.last2() == 'הנ'))):
                        ...
                        if(word.first() == 'ת'):
                            tifilW = Word("","")
                            tifilW.equalTo(word)
                            tifilW.setText(word.last3() + word.getText()[4:-1])
                            tifilW.setRL2(tifilW.thirdFromLast() + tifilW.fourthFromLast())
                            tifilW.setVerbform(12)
                            self.FindHelper(look, tifilW, self.Dict)
                    ...
                    if(not((word.last() == 'ת')or(word.last2() == 'ונ')or(word.last2() == 'ית')or(word.last2() == 'םת')or(word.last2() == 'תן'))):
                        if(word.first() == 'ת'):
                            ...
                            if(word.first2() == 'ית') and (not((word.last() == 'ת')or(word.last2() == 'ונ')or(word.last2() == 'ית')or(word.last2() == 'םת')or(word.last2() == 'תן'))):
                                tifilW2 = Word("","")
                                tifilW2.equalTo(word)
                                tifilW2.setText(word.last3() + word.getText()[4:-2])
                                tifilW2.setRL2(tifilW2.thirdFromLast() + tifilW2.fourthFromLast())
                                tifilW2.setVerbform(12)
                                self.FindHelper(look, tifilW2, self.Dict)
                                return self.perfect(look, tifilW2)
                ...
                if((word.thirdFromLast() == 'י')and(word.fourthFromLast() == 'י')) and (self.num_of_p_roots(word.getText()[4:-1]) < 3):
                    if((word.first() == 'י') or (word.first() == 'נ' ) or (word.first() == 'ת' ) or (word.first() == 'א')) and (not((word.first() == 'ת')and(word.last2() == 'הנ'))):
                        ...
                        if(word.first() == 'ת'):
                            tifilW = Word("","")
                            tifilW.equalTo(word)
                            tifilW.setText(word.last2() + word.getText()[4:])
                            tifilW.setRL2(tifilW.nextToLast() + tifilW.thirdFromLast())
                            tifilW.setVerbform(12)
                            self.FindHelper(look, tifilW, self.Dict)
                    ...
                    if(not((word.last() == 'ת')or(word.last2() == 'ונ')or(word.last2() == 'ית')or(word.last2() == 'םת')or(word.last2() == 'תן'))):
                        if(word.first() == 'ת'):
                            tifilW = Word("","")
                            tifilW.equalTo(word)
                            tifilW.setText(word.last2() + word.getText()[4:-1])
                            tifilW.setRL2(tifilW.nextToLast() + tifilW.thirdFromLast())
                            tifilW.setVerbform(12)
                            self.FindHelper(look, tifilW, self.Dict)
                            self.perfect(look, tifilW)
                            if(word.first2() == 'ית') and (not((word.last() == 'ת')or(word.last2() == 'ונ')or(word.last2() == 'ית')or(word.last2() == 'םת')or(word.last2() == 'תן'))):
                                tifilW2 = Word("","")
                                tifilW2.equalTo(word)
                                tifilW2.setText(word.last2() + word.getText()[4:-2])
                                tifilW2.setRL2(tifilW2.nextToLast() + tifilW2.thirdFromLast())
                                tifilW2.setVerbform(12)
                                self.FindHelper(look, tifilW2, self.Dict)
                                return self.perfect(look, tifilW2)
                        ...
                        if(word.first() == 'ה'):
                            ...
                            if(word.first2() == 'יה')(not((word.last() == 'ת')or(word.last2() == 'ונ')or(word.last2() == 'ית')or(word.last2() == 'םת')or(word.last2() == 'תן'))):
                                hifilW2 = Word("","")
                                hifilW2.equalTo(word)
                ...
                if(word.thirdFromLast() == 'י') and (self.num_of_p_roots(word.getText()[3:-1]) < 3):
                    if((word.first() == 'י') or (word.first() == 'נ' ) or (word.first() == 'ת' ) or (word.first() == 'א')) and (not((word.first() == 'ת')and(word.last2() == 'הנ'))):
                        ...
                        if(word.first() == 'ת'):
                            tifilW = Word("","")
                            tifilW.equalTo(word)
                            tifilW.setText(word.last2() + word.getText()[3:-1])
                            tifilW.setRL2(tifilW.nextToLast() + tifilW.thirdFromLast())
                            tifilW.setVerbform(12)
                            self.FindHelper(look, tifilW, self.Dict)
                    ...
                    if(not((word.last() == 'ת')or(word.last2() == 'ונ')or(word.last2() == 'ית')or(word.last2() == 'םת')or(word.last2() == 'תן'))):
                        ...
                        if(word.first() == 'ת'):
                            ...
                            if(word.first2() == 'ית') and (not((word.last() == 'ת')or(word.last2() == 'ונ')or(word.last2() == 'ית')or(word.last2() == 'םת')or(word.last2() == 'תן'))):
                                tifilW2 = Word("","")
                                tifilW2.equalTo(word)
                                tifilW2.setText(word.last2() + word.getText()[3:-2])
                                tifilW2.setRL2(tifilW2.nextToLast() + tifilW2.thirdFromLast())
                                tifilW2.setVerbform(12)
                                self.FindHelper(look, tifilW2, self.Dict)
                                return self.perfect(look, tifilW2)
        ...
        if((word.nextToLast() == 'י')and(word.thirdFromLast() == 'י')) and (self.num_of_p_roots(word.getText()[3:-1]) < 3):
            if((word.first() == 'י') or (word.first() == 'נ' ) or (word.first() == 'ת' ) or (word.first() == 'א')) and (not((word.first() == 'ת')and(word.last2() == 'הנ'))):
                ...
                if(word.first() == 'ת'):
                    tifilW = Word("","")
                    tifilW.equalTo(word)
                    tifilW.setText(word.last() + word.getText()[3:-1])
                    tifilW.setRL2(tifilW.last() + tifilW.nextToLast())
                    tifilW.setVerbform(12)
                    self.FindHelper(look, tifilW, self.Dict)
                    self.perfect(look, tifilW)
                    if(word.first2() == 'ית'):
                        tifilW2 = Word("","")
                        tifilW2.equalTo(word)
                        tifilW2.setText(word.last() + word.getText()[3:-2])
                        tifilW2.setRL2(tifilW2.last() + tifilW2.nextToLast())
                        tifilW2.setVerbform(12)
                        self.FindHelper(look, tifilW2, self.Dict)
        ...
        if(word.nextToLast() == 'י') and (self.num_of_p_roots(word.getText()[2:]) < 3):
            if((word.first() == 'י') or (word.first() == 'נ' ) or (word.first() == 'ת' ) or (word.first() == 'א')) and (not((word.first() == 'ת')and(word.last2() == 'הנ'))):
                ...
                if(word.first() == 'ת'):
                    tifilW = Word("","")
                    tifilW.equalTo(word)
                    tifilW.setText(word.last() + word.getText()[2:-1])
                    tifilW.setRL2(tifilW.last() + tifilW.nextToLast())
                    tifilW.setVerbform(12)
                    self.perfect(look, tifilW)
                    self.FindHelper(look, tifilW, self.Dict)
                    if(word.first2() == 'ית'):
                        tifilW2 = Word("","")
                        tifilW2.equalTo(word)
                        tifilW2.setText(word.last() + word.getText()[2:-2])
                        tifilW2.setRL2(tifilW2.last() + tifilW2.nextToLast())
                        tifilW2.setVerbform(12)
                        self.FindHelper(look, tifilW2, self.Dict)
        ...
        if((word.last() == 'ת')or(word.last2() == 'ונ')or(word.last2() == 'ית')or(word.last2() == 'םת')or(word.last2() == 'ןת')):
            if(word.first() == 'ה'):
                hifilW = Word("","")
                hifilW.equalTo(word)
            ...
            if(word.first() == 'ת'):
                tifilW = Word("","")
                tifilW.equalTo(word)
                tifilW.setText(word.getText()[:-1])
                tifilW.setVerbform(12)
                self.FindHelper(look, tifilW, self.Dict)
                self.perfect(look, tifilW)
                
                                
                return self.perfect(look, tifilW)
    ...
    def hitpael(self, look, word):
        ...
        if(word.first2() == 'תנ') and (not ((word.Ht == False) or (word.third() == 'ו'))) and ((word.isVerbf() == False) or (word.getVerbform() == 'Qal')):
            nithpaelW = Word("","")
    ...
    def hishtaphel(self, look, word):
        ...
        if(word.nextToFirst() == 'ש') and (word.third() == 'ת') and (word.first() in prefixL):
            hishtaphelW = Word("","")
            hishtaphelW.equalTo(word)
        ...
        if((word.first3() == 'תשי') or (word.first3() == 'תשת' ) or (word.first3() == 'תשא') or (word.first3() == 'תשנ')):
            hishtaphelW = Word("","")
            hishtaphelW.equalTo(word)
            hishtaphelW.setText(word.getText()[:-3] + word.first())
            if(word.isVerbf() == False):
    ...
    def perfect(self, look, word):
        if(word.getLen() < 3) or ('-' in word.getText()) or (word.isTense() == True) or (word.isNoun() == True) or (word.getRL2() == word.last2()) or (word.getHey1() > 0):
            return Word("","")
    ...
    def future(self, look, word):
        if(word.getLen() < 2) or ((word.getLen() < 3) and(not('ו' in word.getPrixList()))) or ('-' in word.getText()) or (word.isTense() == True) or (word.isNoun() == True) or (word.getVerbform() == 'Niphal') or (word.getVerbform() in Pual) or (word.getVerbform() in Piel) or (word.getHey1() > 0):
            return Word("","")
        ...
        if(word.getLen() > 3):
            if((word.first() == 'ת')and(word.last2() == 'הנ')) and (self.imperRules(word, 'ת') == True):
                ...
                if( 'ו' in word.getPrixList())and(futurW.first() == 'ו') :
            ...
            if ('ו' in word.getPrixList()) and(((word.first2() == 'וי') and (word.last() == 'ו') and (self.imperRules(word, 'וי') == True)) or ((word.first2() == 'יי') and (word.last() == 'ו') and (self.imperRules(word, 'יי') == True))):
                futurW = Word("","")
                futurW.equalTo(word)
        ...
        if(word.getLen() > 2):
            if ('ו' in word.getPrixList()) and ((word.first2() == 'וי') and (self.imperRules(word, 'וי') == True)  or  ('ו' in word.getPrixList())and(word.first2() == 'יי') and (self.imperRules(word, 'יי') == True)):
                futurW = Word("","")
                futurW.equalTo(word)
    ...
    def infinitive(self, look, word):
        if((word.getLen() < 3) or ('-' in word.getText()) or (word.getPrixListEnd() == 'מ') or (word.getPrixListEnd() == 'ל') or (word.getPrixListEnd() == 'כ') or ('ה' in word.getPrixList()) or (word.isTense() == True) or (word.isNoun() == True) or (word.getVerbform() == 'Niphal') or (word.getVerbform() in Pual) or (word.getVerbform() in Piel)):
            return Word("","")
    ...
    def cohortative(self, look, word):
        if((word.getLen() < 3) or (word.getPrixListEnd() == 'ל') or ('ה' in word.getPrixList()) or ('-' in word.getText()) or (word.isTense() == True) or (word.isNoun() == True) or (word.getVerbform() == 'Niphal') or (word.getRL2() == word.last2()) or (word.getVerbform() in Pual) or (word.getVerbform() in Piel)):
            return Word("","")
    ...
    def prefixRuls(self, word, p, h):
        ...
        if(word.getVerbform() in Pual) or (word.getVerbform() == 'Niphal') or (word.getVerbform() in Piel) or (word.getPartiVal() == 1):
            return False
        if((word.getPrefix() == True) and (h == False) and ((word.getVerbform() in Hithpeal)or(word.getVerbform() in Hiphil)or(word.getVerbform() == 'Hophal'))):
            return False
    ...
    def suffix(self, look, word, p):
        if(word.getLen() < 3) or (word.getConstruct() == True) or ('ה' in word.getPrixList()) or (word.isVerb() == True) or (word.getSuffix() == True) or (word.getPlural() == True) or (word.getDaul() == True) or (not (word.getTenseVal() == -1)) or (word.getModern == True) or (word.getPartiVal() == 0) or (word.getVerbform() in Pual):
            return Word("","")
    ...
    def dirHey(self, look, word):
        if(word.getLen() < 2) or ('ב' in word.getPrixList()) or ('ל' in word.getPrixList()) or ('מ' in word.getPrixList()) or (word.isVerb() == True) or (word.getSuffix() == True) or (word.getPlural() == True) or (word.getDaul() == True) or (word.getConstruct() == True) or (word.getTense() == 'Participle'):
            return Word("","")
        ...
        if(self.getLstLen(cPhraseHey1) < 3) and ('-' in word.getText()):
            return Word("", "")
    ...
    def suffix1(self, look, word):
        if(word.getLen() < 2) or (word.isVerb() == True) or (word.getSuffix() == True) or (word.getPlural() == True) or (word.getDaul() == True) or (word.getConstruct() == True) or (word.getModern == True) or (word.getRL2() == word.last2()) or (word.getPartiVal() == 0) or (word.getVerbform() in Pual):
            return Word("","")
    ...
    def suffix2(self, look, word):
        if(word.getLen() < 3) or (word.isVerb() == True) or (word.getSuffix() == True) or (word.getPlural() == True) or (word.getDaul() == True) or (word.getConstruct() == True) or (word.getModern == True) or (word.getRL2() == word.last2()) or (word.getRL2() == word.nextToLast() + word.thirdFromLast()) or (word.getPartiVal() == 0) or (word.getVerbform() in Pual):
            return Word("","")
    ...
    def suffix3(self, look, word):
        if(word.getLen() < 4) or (word.isVerb() == True) or (word.getSuffix() == True) or (word.getPlural() == True) or (word.getDaul() == True) or (word.getConstruct() == True) or (word.getModern == True) or (word.getRL2() == word.last3()) or (word.getRL2() == word.thirdFromLast() + word.fourthFromLast()) or (word.getPartiVal() == 0) or (word.getVerbform() in Pual):
            return Word("","")
    ...
    def participle(self, look, word):
        ...
        if(word.last() == 'ת') and (not(word.nextToLast() == 'ו')) and (not(word.getConstruct() == True)) and (word.getLen() > 3):
            ...
            if(word.first() == 'מ') and (not(((word.getPrefix() == True) and ((word.getVerbform() in Hithpeal)or(word.getVerbform() in Hiphil)or(word.getVerbform() == 'Hophal'))))):
                ...
                if(word.getLen() > 3) and ((word.getVerbform() in Piel) or (word.getVerbform() in Hiphil)):
                    isPar = True
                    pword2 = Word("","")
                    pword2.equalTo(word)
    ...
    def constr(self, look, word):
        if(word.getLen() < 2) or (word.getConstruct() == True) or (word.getHey1() > 0) or (word.isVerb() == True) or (word.getTense() == 'Perfect') or (word.getTense() == 'Imperfect') or (word.getTense() == 'Imperative') or (word.getTense() == 'Infinitive') or (word.getPartiVal() == 0) or ((not(word.getPartiVal() == -1))and(word.last() == 'ת')) or (word.getRL2() == word.last2()):
            return Word("", "")
        ...
        if(word.getLen() > 2):
            if(word.last() == 'י') and ((self.CurrentWord.last() == 'י')or(word.getSuffix() == True)) and (not('ם' in word.getSufxList())) and (not(word.getPlural() == True)) and (not(word.getDaul() == True)):
                constW = Word("","")
                constW.equalTo(word)
    ...
    def irreg(self, look, word):
        ...
        if(word.getLen() > 1):
            if(not(word.nextToFirst() == 'נ')) and ((word.first() == 'ה') or (word.first() == 'י')) and (not (word.getVerbform() == 'Niphal')) and (not((word.getVerbform() in Pual) or (word.getVerbform() in Piel) or (word.getPartiVal() == 1))):
                irregW5 = Word("","")
        ...
        if(word.getLen() > 2):
            if(word.nextToFirst() == 'נ') and (not((word.getVerbform() in Pual) or (word.getVerbform() in Piel) or (word.getVerbform() in Hiphil) or (word.isParticiple() == True))):
                irregWN = Word("","")
                irregWN.equalTo(word)
        ...
        if(word.getLen() == 3):
            if (word.nextToLast() == 'ו') or (word.nextToLast() == 'י') and (not((word.last() == 'ה')and(not(self.CurrentWord.last() == 'ה')))):
                hollow = Word("","")
                hollow.equalTo(word)
